...
function isPlacesRoute(pathname: string) {
  return pathname === '/places' || pathname.startsWith('/places/');
}

function isPlaceDetailRoute(pathname: string) {
  return pathname.startsWith('/places/') && pathname !== '/places/map';
}
