...
- 联络帐生成
- 自动育儿日记
- 公开社区评论（ADD 0005：First Release 仅支持本地个人评论与匿名纠错报告，不上传服务端）
- 保育园教师端
- 商家管理后台
- 复杂机器学习推荐
- 付费订阅
...
- 公共 API
- 内容缓存
- 分类扩充与数据扩充（児童館/おもちゃ遊び場/遊園地，JSON 自动收录管线）
- 详情页改版（媒体轮播、标签、票价、预约、基本信息）
- 本地个人评论（IndexedDB）
- 匿名纠错报告（POST /places/:id/reports + 后台报告队列 + 离线待发队列）
